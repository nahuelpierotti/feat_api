...
let Level = class Level extends typeorm_1.BaseEntity {
};
__decorate([
...
__decorate([
    (0, typeorm_1.OneToMany)(() => Player_1.Player, (player) => player.level),
    __metadata("design:type", Array)
], Level.prototype, "player", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => SportGeneric_1.SportGeneric),
    (0, typeorm_1.JoinColumn)({ name: 'sportGenericId' }),
    __metadata("design:type", Number)
], Level.prototype, "sport", void 0);
Level = __decorate([
    (0, typeorm_1.Entity)()
], Level);
exports.Level = Level;
